...
@section('content-title', 'Add Item')
@section('content')
    ...
    <div class="card-body">
        <form action="{{ route('item.store') }}" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <input class="form-control" type="number" name="stock" id="stock" value="{{ old('stock') }}" placeholder="Enter stock quantity..." min="0" required>
                @error('stock')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
